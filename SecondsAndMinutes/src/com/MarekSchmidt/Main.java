...
//    Create a new console project and call it SecondsAndMinutesChallenge
    ...
    public static void main(String[] args) {
        System.out.println(getDurationString(400, 35));
        System.out.println(getDurationString(90, 44));
        System.out.println(getDurationString(-2, 5));
        System.out.println(getDurationString(234, 70));

        System.out.println(getDurationString(-6));
        System.out.println(getDurationString(48075));
